...
print(emotify.EmotifyList[157].EmotifyTimeList[0].Anger, emotify.EmotifyList[157].EmotifyTimeList[1].Anger)
print(emotify.EmotifyList[157].EmotifyTimeList[0].Surprise, emotify.EmotifyList[157].EmotifyTimeList[1].Surprise)
print(emotify.EmotifyList[157].EmotifyTimeList[0].Happy, emotify.EmotifyList[157].EmotifyTimeList[1].Happy)
print(emotify.EmotifyList[157].EmotifyTimeList[0].Sad, emotify.EmotifyList[157].EmotifyTimeList[1].Sad)