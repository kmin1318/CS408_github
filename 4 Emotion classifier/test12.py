...
f = open("문재인_angertweets.txt", 'w', -1, "utf-8")
tweets = emotify.EmotifyList[157][3]
for k in tweets:
    str = '\n'.join(tweets[k])
    str = k + '\n' + str + '\n'
    f.write(str)
...
f = open("문재인_feartweets.txt", 'w', -1, "utf-8")
tweets = emotify.EmotifyList[157][4]
for k in tweets:
    str = '\n'.join(tweets[k])
    str = k + '\n' + str + '\n'
    f.write(str)
...
f = open("문재인_happytweets.txt", 'w', -1, "utf-8")
tweets = emotify.EmotifyList[157][5]
for k in tweets:
    str = '\n'.join(tweets[k])
    str = k + '\n' + str + '\n'
    f.write(str)
...
f = open("문재인_sadtweets.txt", 'w', -1, "utf-8")
tweets = emotify.EmotifyList[157][6]
for k in tweets:
    str = '\n'.join(tweets[k])
    str = k + '\n' + str + '\n'
    f.write(str)
