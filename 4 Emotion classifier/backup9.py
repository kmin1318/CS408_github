...
for keyword in keywords:
    ...
    fst_name = keyword_lst[-2][0]
    lst_name = keyword_lst[-2][1:]
    if fst_name in anger_tweets:
        del anger_tweets[fst_name]
    if fst_name in fear_tweets:
        del fear_tweets[fst_name]
    if fst_name in happy_tweets:
        del happy_tweets[fst_name]
    if fst_name in sad_tweets:
        del sad_tweets[fst_name]
