...
import json
with open('test_print_anger.txt', 'w', -1, "utf-8") as f:
    json.dump(emotify.EmotifyList[157][2].EmotifyTimeList[1].AngerKeyword, f)

import json
with open('test_print_fear.txt', 'w', -1, "utf-8") as f:
    json.dump(emotify.EmotifyList[157][2].EmotifyTimeList[1].SurpriseKeyword, f)
    
import json
with open('test_print_happy.txt', 'w', -1, "utf-8") as f:
    json.dump(emotify.EmotifyList[157][2].EmotifyTimeList[1].HappyKeyword, f)
    
import json
with open('test_print_sad.txt', 'w', -1, "utf-8") as f:
    json.dump(emotify.EmotifyList[157][2].EmotifyTimeList[1].SadKeyword, f)

print(emotify.EmotifyList[157][2].EmotifyTimeList[1].Anger)
print(emotify.EmotifyList[157][2].EmotifyTimeList[1].Surprise)
print(emotify.EmotifyList[157][2].EmotifyTimeList[1].Happy)
print(emotify.EmotifyList[157][2].EmotifyTimeList[1].Sad)